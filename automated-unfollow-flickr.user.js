...
function injectLib(){
  ...
  setTimeout(oneClickUnfollow, 500)
}
// Delay to wait for page to then inject jQuery
setTimeout(injectLib, 500);

// One click unfollow
function oneClickUnfollow(){
...
// Delay long enough for check to run for non-reciprocating users
setTimeout(unfollow, 1000);


// Reload page every 15 seconds to catch followers on page after previous unfollow creating more space on page.
setTimeout(function(){
  window.location.reload();
}, 15000);


// Checks for non-reciprocating users
(function() {
